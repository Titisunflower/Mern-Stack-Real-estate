  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <div className='flex justify-between mt-5'>
        ...
        <span onClick={handleSignOut} className='text-purple-700 cursor-pointer'>
          Sign out
        </span>
      </div>

      <p className='text-red-700 mt-5'>{error ? error : ''}</p>
      <p className='text-purple-700 mt-5'>
        {updateSuccess ? 'User is updated successfully!' : ''}
      </p>
      <button onClick={handleShowHouses} className='text-purple-700 w-full'>
        Show Houses
      </button>
      <p className='text-red-700 mt-5'>
        {showListingsError ? 'Error showing Houses' : ''}
      </p>
